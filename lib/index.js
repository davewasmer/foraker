...
// import memoize from 'lodash-node/modern/function/memoize';
...
export default CoreObject.extend({
  ...
  /**
   * Return the filters from a list of all filters that should run for a given
   * action, taking in to account whitelists, blacklists, and skips.
   *
   ...
   *
   * @return {Array}   The filters from the allFilters list that should apply to
   * the given actionName
   */
      ...
      return handlerChain.each((handler) => {
        ...
        return new Promise((resolve, reject) => {
          ...
          if (result && typeof result.then === 'function') {
            ...
            result.then(resolve).catch((rejectionValue) => {
